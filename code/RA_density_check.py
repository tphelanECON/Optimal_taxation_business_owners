...
fig, ax = plt.subplots()
ax.plot(c_grid[cdf_c < 0.99], cdf_c[cdf_c < 0.99], 'b', label='True', linewidth=1.5)
ax.plot(c_grid[RA_cdf_c < 0.99], RA_cdf_c[RA_cdf_c < 0.99], 'b--', label='True', linewidth=1.5)
ax.legend()
...
fig, ax = plt.subplots()
ax.plot(theta_grid[cdf_theta < 0.99], cdf_theta[cdf_theta < 0.99], 'b', label='True', linewidth=1.5)
ax.plot(theta_grid[RA_cdf_theta < 0.99], RA_cdf_theta[RA_cdf_theta < 0.99], 'b--', label='True', linewidth=1.5)
ax.legend()
